...
create
	make_empty, make_from_pointer, make_from_separate, make_from_value
...
feature {NONE} -- Initialization.
	...
	make_from_value (a_val: BOOLEAN)
			-- Create `Current' with a given value.
		do
			data := a_val
		end
...
feature {NONE} -- Externals
	...
	c_msg_ptr (a_val: BOOLEAN): POINTER
		external
			"C++ inline use %"std_msgs/Bool.h%""
		alias
			"[
