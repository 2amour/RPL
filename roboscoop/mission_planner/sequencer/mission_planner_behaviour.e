...
feature {NONE} -- Initialization
	...
	make_with_attributes (parameters_bag: MISSION_PLANNER_PARAMETERS_BAG)
		...
		do
			create mission_signaler.make_with_attributes (parameters_bag.mission_planner_parameters.frame, parameters_bag.mission_planner_parameters.way_points, parameters_bag.mission_planner_parameters.angle_threshold, parameters_bag.mission_planner_parameters.way_point_threshold, parameters_bag.mission_planner_parameters.open_loop_offset)
