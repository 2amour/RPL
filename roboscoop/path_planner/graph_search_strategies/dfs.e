note
	description: "Depth-first-search implementation of label correcting algorithm."
...
feature {NONE} -- Initialization
	...
	make_default
		...
		do
			...
			open := create {ARRAYED_STACK [LABELED_NODE]}.make (0)
		end
...
feature {ANY} -- Init and Reset
	...
	make_with_size (a_size: INTEGER_32)
		...
		do
			...
			open := create {ARRAYED_STACK [LABELED_NODE]}.make (a_size)
		end
