			...
			if file_checker.check_file (file) then
				...
				loop
					...
					if key.is_equal ("Goal_parameters_file_path") then
						file.read_word
						last_parameters.set_goal_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Thymio_topics_file_path") then
						file.read_word
						last_parameters.set_thymio_topic_path (file.last_string.twin)
					elseif key.is_equal ("LED_code_file_path") then
						file.read_word
						last_parameters.set_led_code_file_path (file.last_string.twin)
					elseif key.is_equal ("ROS_topics_file_path") then
						file.read_word
						last_parameters.set_ros_topics_file_path (file.last_string.twin)
					elseif key.is_equal ("Go_to_goal_PID_parameters_file_path") then
						file.read_word
						last_parameters.set_go_to_goal_pid_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Follow_wall_PID_parameters_file_path") then
						file.read_word
						last_parameters.set_follow_wall_pid_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Leave_wall_PID_parameters_file_path") then
						file.read_word
						last_parameters.set_leave_wall_pid_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Go_to_goal_non_linear_speed_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_go_to_goal_nlsc_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Follow_wall_non_linear_speed_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_follow_wall_nlsc_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Leave_wall_non_linear_speed_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_leave_wall_nlsc_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Go_to_goal_pose_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_go_to_goal_pose_controller_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Follow_wall_pose_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_follow_wall_pose_controller_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Leave_wall_pose_controller_parameters_file_path") then
						file.read_word
						last_parameters.set_leave_wall_pose_controller_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Wall_following_parameters_file_path") then
						file.read_word
						last_parameters.set_wall_following_parameters_file_path (file.last_string.twin)
					elseif key.is_equal ("Range_sensors_parameters_file_path") then
						file.read_word
						last_parameters.set_range_sensors_parameters_file_path (file.last_string.twin)
