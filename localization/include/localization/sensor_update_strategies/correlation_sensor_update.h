/**
 * @file correlation_sensor_update.h
 *
 *  @date Dec 4, 2015
...
#ifndef CORRELATION_SENSOR_UPDATE_H_
#define CORRELATION_SENSOR_UPDATE_H_

/**
 * @brief Cross correlation model implementation of sensor update algorithm.
 *
 */
class CorrelationSensorUpdate : public SensorUpdate
{
public:
  CorrelationSensorUpdate(); ///< Default Constructor
...
#endif /* CORRELATION_SENSOR_UPDATE_H_ */
